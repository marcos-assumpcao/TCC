...
<h1>Alterar Senha {{ $user->name }}<!--<a href="#" type="button" class="btn btn-success float-right">Salvar</a>--></h1>
<div class="panel panel-default">
    <div class="panel-body">
        <form class="form-horizontal" method="POST" action="{{ route('users.updatesenha', $user['id'] ) }}">
            ...
            <div class="panel-body">
                <form class="form-horizontal" method="POST" action="{{ route('users.senha', $user['id'] ) }}">
                    <input name="_method" type="hidden" value="PUT">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input id="name" type="text" disabled="disabled" class="form-control" name="name" value="{{ ($user['name']) }}" required autofocus>
